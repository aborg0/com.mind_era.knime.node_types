 ...
 *
 */
package com.mind_era.knime.node_types.internal;
 ...
 */
public class ToDeleteNodePlugin extends Plugin {
    // The shared instance.
    private static ToDeleteNodePlugin plugin;

    /**
     * The constructor.
     */
    public ToDeleteNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ToDeleteNodePlugin getDefault() {
        return plugin;
    }
